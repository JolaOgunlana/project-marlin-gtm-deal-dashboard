...
const CM_DATA: CMClient[] = [
  ...
  { name:"UMB", id:"9463", rev:10320970, region:"NA", dealType:"existing", wave:1, stage:1, out:"Medium", off:"Low", dig:"Medium", price:"Low",
    preNudgeX: -2.665, lockPostPosition: true, absPostX: 78, absPostY: 17,
    post:{
  ...
  { name:"NatWest", id:"IVRRBS", rev:25243, region:"EMEA-UK", dealType:"existing", wave:1, stage:1, out:"Medium", off:"Medium", dig:"Medium", price:"High", lockPrePosition:true, lockPostPosition:true, absPostX: 77, absPostY: 26,
    post:{
