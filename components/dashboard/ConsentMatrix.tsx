...
{ name:"Metro Bank", id:"METRO", rev:11793783, region:"EMEA-UK", dealType:"existing", wave:1, stage:3, out:"High", off:"Medium", dig:"High", price:"Low",
    lockPostPosition: true, absPostX: 50, absPostY: 83,
  ...
  absPostX: 49, absPostY: 7, lockPrePosition: true, absPreX: 44, absPreY: 13,
  post:{
  ...
  { name:"UBS Financial Services Inc.", id:"7826", rev:8332814, region:"NA", dealType:"existing", wave:1, stage:3, out:"Medium", off:"Low", dig:"Medium", price:"High", postPlotOut: "Medium", absPostX: 50, absPostY: 50,
    post:{
  ...
  { name:"HSBC (Global)", id:"", rev:8100000, region:"Global", dealType:"new", isPrime:true, wave:3, stage:1, out:"High", off:"High", dig:"High", price:"Low",
    post:{
      out:{ rating:"High", rationale:"High propensity to outsource confirmed following the whisper conversation." },
      off:{ rating:"High", rationale:"High propensity to offshore confirmed following the whisper conversation." },
  ...
  { name:"HSBC Technology & Services (USA)", id:"9368", rev:2876755, region:"NA", dealType:"existing", wave:1, stage:3, out:"Medium", off:"High", dig:"High", price:"Medium",
    post:{
      ...
      dig:{ rating:"High", rationale:"High propensity across all levers following the whisper conversation." },
      price:{ rating:"High", rationale:"High propensity across all levers following the whisper conversation." },
    },
    lockPostPosition: true, absPostX: 97, absPostY: 6,
  },
  ...
  { name:"Brim Financial", id:"9159", rev:1057228, region:"NA", dealType:"existing", wave:1, stage:1, out:"Low", off:"Low", dig:"High", price:"Low",
    post:{
      out:{ rating:"Low", rationale:"Low propensity to outsource following the whisper conversation." },
      off:{ rating:"Low", rationale:"Low propensity to offshore following the whisper conversation." },
      dig:{ rating:"High", rationale:"High propensity to digitize following the whisper conversation." },
      price:{ rating:"Low", rationale:"Low propensity on price flexibility following the whisper conversation." },
    },
    lockPostPosition: true, absPostX: 3, absPostY: 94,
  },
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10, flexShrink: 0 }}>
            <div style={{
              ...
              <span style={{ fontSize: 13, fontWeight: 700, color: '#ffffff', letterSpacing: '0.01em', whiteSpace: 'nowrap' }}>
                ACV Target $25M by Feb 1st 2027
              </span>
            </div>
...
<div style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.06em', textTransform: 'uppercase', marginTop: 4, marginBottom: 1 }}>Next Update</div>
  <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.75)', whiteSpace: 'nowrap' }}>September 29th 2026 · 18:00 EST</div>
            </div>
          </div>
        </div>
