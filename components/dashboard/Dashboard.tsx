...
export function Dashboard({ page, onNavigate }: { page: Page; onNavigate: (p: Page) => void }) {
  ...
  return (
    <div className="db-wrap" style={{ fontFamily: "var(--font-inter), 'Source Sans 3', system-ui, sans-serif" }}>
      ...
      <div style={{
        background: "linear-gradient(90deg, rgba(22,24,56,0.68) 0%, rgba(22,24,56,0.68) 100%), url('/images/marlin-banner-bridge.jpg')",
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20, flexWrap: 'wrap', paddingBottom: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={{ fontSize: 46, fontWeight: 900, color: '#ffffff', letterSpacing: '-0.01em', lineHeight: 1.05, fontFamily: "var(--font-inter), 'Source Sans 3', system-ui, sans-serif" }}>
              Project Marlin - Consent Tracker
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10, flexShrink: 0 }}>
            ...
            <div style={{ textAlign: 'right', lineHeight: 1.65 }}>
              ...
              <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(255,255,255,0.75)', whiteSpace: 'nowrap' }}>Aug 13th 2026 · 18:00 EST</div>
