                ...
                return (
                  <>
                    ...
                    <div style={{ display: 'flex', padding: '10px 22px 0' }}>
                      <div style={{ flex: 4 }}>
                  <span style={{ fontSize: 16, fontWeight: 800, letterSpacing: '0.005em', color: INK, textTransform: 'uppercase', fontFamily: "var(--font-inter), 'Source Sans 3', system-ui, sans-serif", whiteSpace: 'nowrap' }}>
                  Exploration
                        </span>
                      </div>
                      <div style={{ width: 30, flexShrink: 0 }} />
                      <div style={{ flex: 2 }}>
                  <span style={{ fontSize: 16, fontWeight: 800, letterSpacing: '0.005em', color: ALIGNMENT, textTransform: 'uppercase', fontFamily: "var(--font-inter), 'Source Sans 3', system-ui, sans-serif", whiteSpace: 'nowrap' }}>
                  Alignment
                        </span>
                      </div>
                    </div>
