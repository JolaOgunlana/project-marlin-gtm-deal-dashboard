    ...
    stages: [
      {
        ...
        status: 'active',
        evidence: [
    { status: 'y', question: 'Have whisper conversations been held?', answer: 'Yes. Whisper held.', date: '15 May 2026', link: 'faqNew' },
    { status: 'y', question: 'Did the client request additional information?', answer: 'Yes. Open to further outsourcing; concerns around PRA regulation and offshore voice flagged.', link: 'faqNew' },
    ...
    stages: [
      {
        ...
        status: 'active',
        evidence: [
    { status: 'y', question: 'Have whisper conversations been held?', answer: 'Yes. Whisper held.', date: '8 Jun 2026', link: 'faqNew' },
    { status: 'y', question: 'Did the client request additional information?', answer: 'Yes. Requested case studies on digital transformation and geographic delivery capabilities.', link: 'faqNew' },
    ...
    stages: [
      {
        ...
        status: 'done',
        evidence: [
    { status: 'y', question: 'Have whisper conversations been held?', answer: 'Yes. Whisper held.', date: '22 May 2026', link: 'faqNew' },
    { status: 'y', question: 'Did the client request additional information?', answer: 'Yes. Requested offshore capability details and delivery location options for voice and back-office.', link: 'faqNew' },
    ...
    stages: [
      {
        ...
        status: 'active',
        evidence: [
    { status: 'y', question: 'Have whisper conversations been held?', answer: 'Yes. Whisper held.', date: '28 May 2026', link: 'faqNew' },
    { status: 'q', question: 'Did the client request additional information?', answer: 'No request yet', link: 'faqNew' },
...
function EvidenceRows({ rows, onLink }: { rows: EvidenceRow[]; onLink: (target: 'faqNew') => void }) {
  return (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 18, paddingTop: 16 }}>
              {client.stages.map(s => (
                <div key={s.step} style={{ border: BORDER, borderRadius: 10, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <EvidenceRows
                    rows={s.evidence}
                    onLink={target => onLink(target === 'debrief' ? 'debrief' : 'faqNew')}
                  />
                </div>
              ))}
            </div>
  ...
  names: ['First Bank Puerto Rico', 'Centene Corporation', 'ServisFirst', 'Union Bank', 'Citizens Bank', 'The Bank of Nova Scotia', 'Citibank', 'Empire Innovation Group', 'MotivHealth'],
    ...
    label: 'Pitch Scheduled', date: null, barColor: ALIGNMENT, acv: '$43.1M', acvColor: ALIGNMENT,
      ...
      names: ['HSBC (Sep 21)', 'Fifth Third (Sep 24)', 'Citibank (Sep 25)', 'Union Bank (Sep 29)', 'Virgin Money (Oct 5)'],
            ...
            {
  label: 'Pitch ETA', date: 'Sep 31', barColor: ALIGNMENT, acv: '$11.8M', acvColor: ALIGNMENT,
  meta: '2 clients · 13% of ACV · 10% of clients',
  names: ['UBS', 'Centene'],
              nameColor: INK,
            },
          ]
 ...
 <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(26,31,78,0.42)', lineHeight: 1.4, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Avg. propensity score (in-scope)</div>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={{ padding: '20px 20px 0', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14 }}>
              ...
              <div style={{ background: '#fff', padding: '24px 22px', borderRadius: 12, border: '1px solid #e2e4ee', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
  <div style={{ fontSize: 40, fontWeight: 900, color: '#4bcd3e', lineHeight: 1, marginBottom: 8 }}>5</div>
  <div style={{ fontSize: 12, fontWeight: 500, color: 'rgba(26,31,78,0.42)', lineHeight: 1.4, textTransform: 'uppercase', letterSpacing: '0.05em' }}>In Wave 2 whisper scope (15 not planned)</div>
              </div>
          ...
          <div style={{ overflow: 'hidden', borderTop: BORDER }}>
            ...
            {(() => {
              const allRows = [
                ...
                { name: 'FRES travel card',               acv: '$1.8M',  wave: 'Wave 3', sfStage: '1', out: 'Medium', off: 'High',       dig: 'High',   price: 'Medium', score: null, status: 'No Whisper' },
                { name: 'FRES Cash',                      acv: '$1.2M',  wave: 'Wave 3', sfStage: '1', out: 'Medium', off: 'High',       dig: 'High',   price: 'Medium', score: null, status: 'No Whisper' },
                { name: 'Landesbankinn',                  acv: '$1.1M',  wave: 'Wave 3', sfStage: '1', out: 'Medium', off: 'High',       dig: 'High',   price: 'Medium', score: null, status: 'No Whisper' },
                { name: 'Federal Bank of India',          acv: '$0.3M',  wave: 'Wave 3', sfStage: '1', out: 'Low',    off: 'Medium',     dig: 'High',   price: 'Medium', score: null, status: 'No Whisper' },
              ]
              ...
              const rows =
                waveFilter === 'All'
                  ...
                  : waveFilter === 'Prime Clients'
                    ...
                    : allRows.filter(r => r.wave === waveFilter)
