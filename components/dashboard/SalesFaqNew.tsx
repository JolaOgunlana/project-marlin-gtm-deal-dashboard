...
const FAQ_NEW_DATA: FaqNewRow[] = [
  ...
  },
  {
    ...
    response: "[9/22/2026] At a high level, Voice will be delivered across North America, EMEA and Manila; Back Office will be delivered from India where client consent permits.",
  ...
  {
    category: "Outsourcing & Offshoring / (DO NOT ASK Genpact)",
    sharedWithGenpact: "No",
    points: "Will our work be done through global delivery locations?",
  ...
  },
  {
    category: "Outsourcing & Offshoring / (DO NOT ASK Genpact)",
    sharedWithGenpact: "No",
    points: "Are you bringing in support delivery partners?",
  ...
  },
  {
    category: "Outsourcing & Offshoring / (DO NOT ASK Genpact)",
    sharedWithGenpact: "No",
    points: "Who delivers this, and do we have a say?",
  ...
  {
    category: "Consent / (DO NOT ASK Genpact)",
    sharedWithGenpact: "No",
    points: "Is outsourcing mandatory, and what happens if a client refuses it outright? What is the impact to pricing?",
  ...
  },
  {
    category: "Consent / (DO NOT ASK Genpact)",
    sharedWithGenpact: "No",
    points: "What happens if a client doesn't want to offshore and is a client in the following countries: a) US, b) Canada, c) UK, d) Germany, e) Netherlands",
    response: "",
    responseDate: "",
    status: "Delayed" as FaqNewStatus,
    followUp: "9-10",
  ...
  {
    category: "Transition / (DO NOT ASK GENPACT)",
    sharedWithGenpact: "No",
    points: "The pitch deck refers to \"same team\" - how much of a same team can be secured? What does this mean in practice? When we communicate this to clients we must be precise.",
    response: "[8/7/2026]  Yes — continuity is secured at the operational level, not just senior oversight. From day one we will  rebadge to Genpact. The team structure and the reporting lines stays intact.\nAll services and processes stay the same as currently delivered: Direct line into the operation, escalation path/gate, change management process, quality framework, oversight of training, monthly model and staffing reviews, oversight of case decisioning. This also extends to any seat a partner operates.",
    responseDate: "[8/7/2026]",
    status: "Complete" as FaqNewStatus,
    followUp: "",
    commentPwc: "",
  },
  {
    category: "In / Out of Scope Services",
    sharedWithGenpact: "No",
    points: "Is a) IVR and b) mailroom out of scope?",
    response: "[8/21/2026]: a) The transformation of the IVR is in scope for the vendor, the maintenance and configuration of the IVR will be retained by FIS. IVR technology is on FIS side, if they are IVR only clients like … these clients will be prioritized for Wave 3, technology is not out of scope it IVR only client are just deprioritized\nb) Mailroom is out of scope, the work that comes out of the mailroom and is put into a queue is in scope.",
    responseDate: "[8/21/2026]",
    status: "Complete" as FaqNewStatus,
    followUp: "",
    commentPwc: "",
  },
  {
    category: "Technology",
    sharedWithGenpact: "No",
    points: "What is the 1-1 replacement of legacy tools across the tech stack? Stephen lists several that are outside CCaaS and CRM. Genpact operates backoffice for Gamma so they may be bringing those tools here.",
    response: "[8/26/26:]\nCCaaS\n\n1. Avaya (NA) → NICE CX One\n\nIn scope: migrate and transform from Avaya to NICE CX One. Includes AI overlay deployment as part of CCaaS build.\nTiming: 6–12 months (to be validated)\n\n2. Avaya (EMEA) → NICE CX One\n\nIn scope: migrate and transform from Avaya to NICE CX One. Includes AI overlay deployment as part of CCaaS build.\nTiming: 6–12 months (to be validated)\n\n3. AWS Connect (EMEA, select clients) → NICE CX One\n\nIn scope: migrate and transform from Avaya to NICE CX One. Includes AI overlay deployment as part of CCaaS build.\nTiming: 6–12 months (to be validated)\n\n4. Verint WFO (EMEA) / Avaya WFO (NA) → NICE CX One\n\nIn scope: migrate and transform from Avaya to NICE CX One. Includes AI overlay deployment as part of CCaaS build.\nTiming: 6–12 months (to be validated)\nTelephony / Carrier\n\n5. Avaya Phone System (NA) → Lumen/Verizon (NA)\n\nIn scope: integration with carrier infrastructure. Not in scope: carrier contracts (FIS-owned).\nTiming: 6–12 months (to be validated)\n\n6. Avaya Telephony / Core Telephony, BT SmartNumbers, Tiger (EMEA) → BT (EMEA)\n\nIn scope: integration with carrier infrastructure. Not in scope: carrier contracts (FIS-owned).\nTiming: 6–12 months (to be validated)\nIVR / Self-Service\n\n7. Genesys IVR → Avaya AAEP (NA, in-flight) → Microsoft D365 CC (Power Platform)\n\nIn scope: migrate and transform to D365 CC. DTMF prompts re-engineered to Conversational AI/NLU — not replicated. Funding for Core Essential API support for In scope work. Not in scope: replication of existing DTMF capability.\nTiming: Genesys → Avaya: in-flight (NA). Avaya → D365 CC: 6–12 months (to be validated)\n\n8. Avaya AAEP / Experience Portal (EMEA) → Microsoft D365 CC (Power Platform)\n\nIn scope: migrate and transform to D365 CC. DTMF prompts re-engineered to Conversational AI/NLU — not replicated. Funding for Core Essential API support for In scope work. Not in scope: replication of existing DTMF capability.\nTiming: 6–12 months (to be validated)\nCRM — NA\n\n9. Legacy GUIs — Fraud GUI, Dispute & Risk GUI, Case Log, Nomad (TS2 clients) → TCS Cloud\n\nIn scope: funding and resourcing client migration to TCS Cloud, legacy data archival. Not in scope: TCS product roadmap, Pega upgrade, TS2 processing platform.\nTiming: ~3 months per client, 7-10 clients at a time; 9-12 months\nCRM — NA / CRM — EMEA\n\n10. TCS Onprem — TS2 clients (NA & EMEA) → TCS Cloud\n\nIn scope: funding and resourcing client migration to TCS Cloud. Not in scope: TCS product roadmap, Pega upgrade, TS2 processing platform.\nTiming: ~4-5 months per client, 4-5 clients at a time; 9-12 months\nCRM — EMEA/APAC\n\n11. Prime (AWS-hosted) → Prime (cloud-native, AWS)\n\nIn scope: dependency management for the integrations. Not in scope: Prime product roadmap.\nTiming: To be confirmed (to be validated)\n\n12. FreshVue / SoVision → Prime (cloud-native, AWS)\n\nIn scope: dependency management for the integrations. Not in scope: Prime product roadmap.\nTiming: To be confirmed (to be validated)\nOperational Tools/Offerings — NA\n\n13. Fraud Strategy Tools → Digital Servicing (cloud-native, AWS)\n\nIn scope: funding and resourcing client migration & support to Digital Servicing Platform. Not in scope: platform build for R2 scope (FIS-owned).\nTiming: R1 in flight; R2 target 2027 (to be validated)\n\n14. Complaint Resolution Tracker → Digital Servicing (cloud-native, AWS)\n\nIn scope: funding and resourcing client migration & support to Digital Servicing Platform. Not in scope: platform build for R2 scope (FIS-owned).\nTiming: R1 in flight; R2 target 2027 (to be validated)\n\n15. OTP → Digital Servicing (cloud-native, AWS)\n\nIn scope: funding and resourcing client migration & support to Digital Servicing Platform. Not in scope: platform build for R2 scope (FIS-owned).\nTiming: R1 in flight; R2 target 2027 (to be validated)\n\n16. Queuing → Digital Servicing (cloud-native, AWS)\n\nIn scope: funding and resourcing client migration & support to Digital Servicing Platform. Not in scope: platform build for R2 scope (FIS-owned).\nTiming: R1 in flight; R2 target 2027 (to be validated)\nOperational Tools/Offerings — EMEA\n\n17. TMS EMEA legacy applications (agent productivity/operational activities) → Digital Servicing (cloud-native, AWS)\n\nIn scope: modernize onto Digital Servicing platform - funding and resourcing & support.\nTiming: Day 1 on legacy; 9-12 months for build & rollout\nOperational & Analytical Reporting\n\n18. Legacy Reporting → Cognos through Issuer, Data Lake for standard product reports\n\nIn scope: new analytical reporting generation using FIS/TIS technology toolset. Funding and resourcing for reporting build. Not in scope: reporting framework.\nTiming: Day 1 on legacy; post-migration of clients - future state (to be validated)\n\n19. Legacy Reporting → CX Operational reports - FIS CX BI Reporting\n\nIn scope: new analytical reporting generation using FIS/TIS technology toolset. Funding and resourcing for reporting build. Not in scope: reporting framework.\nTiming: Day 1 on legacy; post-migration of clients - future state (to be validated)",
  ...
  },
  {
    ...
    response: "[9/22/2026] Genpact owns and operates the contact center and carries the obligation to deliver the efficiency, whether or not its AI tooling is used.\nFIS is outsourcing the operations and retains governance: a rigorous oversight model is going into place where nothing proceeds without FIS approval, backed by a governance exhibit and audit and compliance obligations on Genpact in the master agreement.\nThe AI platform is Genpact's own SaaS on Genpact's AWS, not licensed to FIS. Agents, supervision, and training were not broken out individually",
    responseDate: "[9/22/2026]",
    status: "Complete" as FaqNewStatus,
    followUp: "",
  ...
  },
  {
    category: "Operations",
    sharedWithGenpact: "No",
    points: "HSBC specific: What will happen to existing TMS Manila ops staff working Ts2 for US?",
    response: "[9/10/2026]\nAt this stage, it is too early to determine the impact, if any, on existing TMS Manila employees supporting TS2 for the U.S. market. Workforce and location planning activities have not yet been completed and will be addressed as part of the detailed transition and operating model design. Our primary objective will be to ensure a seamless experience for clients and customers, with no disruption to service quality, regardless of agent or delivery location. The staff will be retained by Genpact and resources dedicated to HSBC will remain tied to you.",
    responseDate: "[9/10/2026]",
    status: "Complete" as FaqNewStatus,
    followUp: "",
    commentPwc: "",
  },
  {
    category: "Outsourcing & Offshoring",
    sharedWithGenpact: "No",
    points: "What experience do Genpact have of Prime?",
    response: "[9/10/2026] Genpact has significant experience supporting card issuing, payments operations, customer servicing, and platform transition/transformation initiatives across the financial services industry. The focus should be on their ability to support the operating processes surrounding the platform, leveraging FIS platform expertise where required. Detailed platform-specific training and knowledge transfer would be incorporated into any transition plan. TIS will continue to own and operate all processor platforms including Prime. TIS will deploy new Agent Desktop tools to drive Agent Experience and productivity which will be the primary interface for Genpact agents.",
    responseDate: "[9/10/2026]",
    status: "Complete" as FaqNewStatus,
    followUp: "",
    commentPwc: "",
  ...
  {
    category: "Technology / Pricing / DO NOT ASK GENPACT",
    sharedWithGenpact: "No",
    points: "Can we confirm which contact centre products sit with GenPact and with FIS directly as a running cost, not transformation? IVR, Call Back Assist, Speech Analytics, Robotics, Voice Biometrics, Fraud Telephony services, Chat, etc. For example, it is my understanding that IVR is being transformed by GenPact and FIS, but the running costs sits with FIS directly going forward, which means that the IVR will be additional costs outside the GenPact fixed fee for the client going forward, and will need to be accounted for in the P&L.",
    response: "",
    responseDate: "",
    status: "Delayed" as FaqNewStatus,
    followUp: "9-10",
...
const COLUMNS: { key: ColKey; label: string; width: string }[] = [
  ...
  { key: 'points',            label: 'Questions',            width: '19%' },
